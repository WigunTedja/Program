...
def benchmark_dekripsi():
    print("\nBenchmark  Memori Dekripsi (dengan GC Manual)")
    ...
    for size in keys_arr:
        print(f"\n--- Dekripsi 100 data dengan kunci {size}-bits ---")
        peak_memory_arr = []
