...
def benchmark_enkripsi():
    print("\nBenchmark  Memori Enkripsi (dengan GC Manual)")
    ...
    for size in keys_arr:
        print(f"\n--- Enkripsi 100 data dengan kunci {size}-bits ---")
        peak_memory_arr = []
